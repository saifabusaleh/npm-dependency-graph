...
let DependenciesInputComponent = class DependenciesInputComponent {
...
DependenciesInputComponent.ctorParameters = () => [
...
let TreeChartComponent = class TreeChartComponent {
    constructor() {
    ...
    buildTree(treeData) {
        ...
        let svg = d3__WEBPACK_IMPORTED_MODULE_2__["select"](this.element).append('svg')
        ...
        let treeMap = d3__WEBPACK_IMPORTED_MODULE_2__["tree"]().size([this.height - this.margin.top - this.margin.bottom, this.width - this.margin.left - this.margin.right]);
